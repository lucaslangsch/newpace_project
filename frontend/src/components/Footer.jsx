    ...
    <footer className="footer-home">
      <div className="footer-left">
        ...
        <nav className="nav-footer-link">
          <a className="link" href="https://www.instagram.com/newpaceassessoria/"><AiOutlineInstagram /></a>
          <a className="link" href="https://wa.me/5548999408873?text=Ol%C3%A1,%20gostaria%20de%20saber%20mais%20sobre%20os%20planos%20da%20Newpace"><AiOutlineWhatsApp /></a>
        </nav>
      </div>
